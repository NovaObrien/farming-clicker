...
export const AppState = reactive({
  ...
  smallFarms: [{ id: 1, name: 'Birch Wood Farm', acers: 10, type: 'Hay', beds: 2 }, { id: 3, name: 'CreekBend Cottage', acers: 20, type: 'Hay', beds: 2 }, { id: 4, name: 'Oak Acres', acers: 30, type: 'Hay', beds: 3 }, { id: 5, name: 'Old Homestead', acers: 15, type: 'Hay', beds: 3 }],
